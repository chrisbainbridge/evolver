...
# this isnt a problem anymore with python 2.4.4
   ...
   os.umask(022) # chrb - this seems more sensible
   # Redirect the standard file descriptors to /dev/null.
   os.open("/dev/null", os.O_RDONLY)    # standard input (0)
#   os.open("/dev/null", os.O_RDWR)       # standard output (1)
   os.open("/tmp/client.stdout", os.O_WRONLY|os.O_TRUNC|os.O_CREAT,0666)       # standard output (1)
#   os.open("/dev/null", os.O_RDWR)       # standard error (2)
   os.open("/tmp/client.stderr", os.O_WRONLY|os.O_TRUNC|os.O_CREAT,0666)       # standard error (2)
