...
class TestClusterRate(Cluster, TestCase):
    g = 'test_cluster_rate'
    args = '-p 50 -t 30 -g 2 --top full --timing sync --model sine --neurons 5 --sim bpg --fitness movement'
    def test_3_run(self):
...
class SingleRate(Cluster, TestCase):
    g = 'test_single_rate'
    args = '-p 20 -t 30 -g 2 --top full --timing sync --model sine --neurons 5 --sim bpg --fitness meandistance'
    def test_2_run(self):
        ev_test.main('ev.py -r %s -g 10'%self.g)
